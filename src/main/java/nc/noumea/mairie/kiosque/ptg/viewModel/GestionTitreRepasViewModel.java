...
//			}
	...
	public void approuverAllPointage() {
		if (getListePointages() == null || getListePointages().size() == 0) {
			...
			filtrer();
			BindUtils.postNotifyChange(null, null, GestionTitreRepasViewModel.this, "listePointages");
		} else {
			// #15281
			Integer nbPtg = 0;
					...
					Messagebox.CANCEL | Messagebox.OK, "", new EventListener() {
						...
						public void onEvent(Event evt) throws InterruptedException {
							if (evt.getName().equals("onOK")) {
								...
								filtrer();
								BindUtils
										.postNotifyChange(null, null, GestionTitreRepasViewModel.this, "listePointages");
							}
						}
					});
		}
