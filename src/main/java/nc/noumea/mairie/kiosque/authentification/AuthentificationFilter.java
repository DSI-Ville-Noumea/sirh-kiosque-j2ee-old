...
public class AuthentificationFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException,
		...
		// logger.info("REQUEST HEADER HTTP_X_PROXY_REMOTE_USER : " +
		// request.getHeader("HTTP_X_PROXY_REMOTE_USER"));
		// logger.info("REQUEST HEADER REMOTE_USER : " +
		// request.getHeader("REMOTE_USER"));
		// logger.info("REQUEST HEADER HTTP_REMOTE_USER : " +
		// request.getHeader("HTTP_REMOTE_USER"));
		// logger.info("REQUEST HEADER REMOTE-USER : " +
		// request.getHeader("REMOTE-USER"));
		// logger.info("REQUEST HEADER HTTP-REMOTE-USER : " +
		// request.getHeader("HTTP-REMOTE-USER"));
		// logger.info("REQUEST HEADER CAS-User : " +
		// request.getHeader("CAS-User"));
		// logger.info("REQUEST HEADER X-Forwarded-User : " +
		// request.getHeader("X-Forwarded-User"));
		// logger.info("REQUEST HEADER REMOTE_HOST : " +
		// request.getHeader("REMOTE_HOST"));
		// logger.info("REQUEST HEADER REMOTE_IDENT : " +
		// request.getHeader("REMOTE_IDENT"));
		// logger.info("REQUEST HEADER REMOTE_ADDR : " +
		...
		// logger.info("REQUEST ATTRIBUT HTTP_X_PROXY_REMOTE_USER : " +
		// request.getAttribute("HTTP_X_PROXY_REMOTE_USER"));
		// logger.info("REQUEST ATTRIBUT REMOTE_USER : " +
		// request.getAttribute("REMOTE_USER"));
		// logger.info("REQUEST ATTRIBUT HTTP_REMOTE_USER : " +
		// request.getAttribute("HTTP_REMOTE_USER"));
		// logger.info("REQUEST ATTRIBUT REMOTE-USER : " +
		// request.getAttribute("REMOTE-USER"));
		// logger.info("REQUEST ATTRIBUT HTTP-REMOTE-USER : " +
		// request.getAttribute("HTTP-REMOTE-USER"));
		// logger.info("REQUEST ATTRIBUT CAS-User : " +
		// request.getAttribute("CAS-User"));
		// logger.info("REQUEST ATTRIBUT X-Forwarded-User : " +
		// request.getAttribute("X-Forwarded-User"));
		// logger.info("REQUEST ATTRIBUT REMOTE_HOST : " +
		// request.getHeader("REMOTE_HOST"));
		// logger.info("REQUEST ATTRIBUT REMOTE_IDENT : " +
		// request.getHeader("REMOTE_IDENT"));
		// logger.info("REQUEST ATTRIBUT REMOTE_ADDR : " +
		// request.getHeader("REMOTE_ADDR"));
		// logger.info("REQUEST ATTRIBUT user-agent : " +
		// request.getHeader("user-agent"));
		// logger.info("REQUEST ATTRIBUT USER-AGENT : " +
		// request.getHeader("USER-AGENT"));
		// logger.info("----------------- RESPONSE HEADER ----------------");
		// logger.info("RESPONSE HEADER HTTP_X_PROXY_REMOTE_USER : " +
		// response.getHeader("HTTP_X_PROXY_REMOTE_USER"));
		// logger.info("RESPONSE HEADER REMOTE_USER : " +
		// response.getHeader("REMOTE_USER"));
		// logger.info("RESPONSE HEADER HTTP_REMOTE_USER : " +
		// response.getHeader("HTTP_REMOTE_USER"));
		// logger.info("RESPONSE HEADER REMOTE-USER : " +
		// response.getHeader("REMOTE-USER"));
		// logger.info("RESPONSE HEADER HTTP-REMOTE-USER : " +
		// response.getHeader("HTTP-REMOTE-USER"));
		// logger.info("RESPONSE HEADER CAS-User : " +
		// response.getHeader("CAS-User"));
		// logger.info("RESPONSE HEADER X-Forwarded-User : " +
		// response.getHeader("X-Forwarded-User"));
