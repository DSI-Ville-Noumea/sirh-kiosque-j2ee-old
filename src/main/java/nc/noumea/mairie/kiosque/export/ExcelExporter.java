...
import nc.noumea.mairie.kiosque.export.excel.CellValueSetter;
import nc.noumea.mairie.kiosque.export.excel.CellValueSetterFactory;
import nc.noumea.mairie.kiosque.export.excel.CellValueSetterFactoryImpl;
...
public class ExcelExporter extends AbstractExporter<XSSFWorkbook, Row> {
	...
	// export header
	private class ExportColumnHeaderInterceptorImpl implements Interceptor<XSSFWorkbook> {
